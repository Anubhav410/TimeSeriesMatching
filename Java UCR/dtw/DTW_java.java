...
public class DTW_java 
{
	...
	public static void main(String[] args) throws IOException 
	{
		...
		q = readFile(new File("Query2.txt"), m);
...
//		System.out.println("mid time: " + (System.currentTimeMillis() - startTime));
		...
		Scanner ssc = new Scanner(new File("Data.txt"));
...
//				System.out.println("Awesome i am here....." + it);
	...
	{
		if(id==1)
			System.out.println("ERROR : Memory can't be allocated!!!\n\n");
		else if ( id == 2 )
		...
		else if ( id == 4 )
		{
			...
			System.out.println("Command Usage:  UCR_DTW.exe  data-file  query-file   m   R\n\n");
			System.out.println("For example  :  UCR_DTW.exe  data.txt   query.txt   128  0.05\n");
		}
		System.exit(1);
	}
